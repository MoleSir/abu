...
use abu_rag::{document::{DocumentProcessor, ParagraphChunker, TextLoader}, embed::Embedder, vectordb::{MemoryVectorStore, VectorDB}};
...
async fn result_main() -> anyhow::Result<()> {
    ...
    let mut vectordb = MemoryVectorStore::new();
